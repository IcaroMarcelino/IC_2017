...
import time
ran = [[[10,10,10,10,10,10,10,10,10], range(200,210)]]
arq = 0
...
for param in ran:
	for i in param[1]:
		...
		# Fit
		regressor.fit(x = x_train, y = y_train, steps = 5500000, batch_size = 50, input_fn = None, monitors = None, max_steps = None)
		...
		info = open("INFO_DL_EXP_EXTRA2.csv", 'a')
