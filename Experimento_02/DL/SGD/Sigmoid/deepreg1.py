...
structure = [(5,1,20,40), 	(5,1,100,200), 		(5,1,200,400), 		(5,1,400,800), 	(5,1,800,1600)]
	...
	for ALEA in [True, False]:
		...
		for param in ran:
			for i in param[1]:
				...
				regressor = tf.contrib.learn.DNNRegressor(feature_columns=feature_columns, hidden_units=param[0], optimizer=tf.train.GradientDescentOptimizer(learning_rate=1e-5),activation_fn = tf.nn.sigmoid)
