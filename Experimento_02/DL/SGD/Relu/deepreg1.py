	...
	for ALEA in [True, False]:
		...
		for param in ran:
			for i in param[1]:
				...
				regressor = tf.contrib.learn.DNNRegressor(feature_columns=feature_columns, hidden_units=param[0], optimizer=tf.train.GradientDescentOptimizer(learning_rate=1e-5))
